...
-->
				...
				<div class="list01_btn_group text-center">
					<?php if ($update_href && $is_admin) { ?><a href="<?php echo $update_href ?>" class="btn bg_black color_white">수정</a><?php } ?>
					<?php if ($delete_href && $is_admin) { ?><a href="<?php echo $delete_href ?>" class="btn bg_darkred color_white" onclick="del(this.href); return false;">삭제</a><?php } ?>
