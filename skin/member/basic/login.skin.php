...
<div class="width-fixed">
	<section class="login_section">
		...
		<div class="section01_content wrap form">
			<div id="login_form">
				<form name="flogin" action="<?php echo $login_action_url ?>" onsubmit="return flogin_submit(this);" method="post">
					...
					<input type="submit" value="로그인" class="grid_100 login_input bg_darkred white">
                    <?php
                    // 소셜로그인 버튼
				...
				<div class="login_link">
					<ul>
						<li>아이디/비밀번호를 잊어버리셨나요?<a href="<?php echo G5_BBS_URL ?>/password_lost.php?lat=<?php echo $lat; ?>&lng=<?php echo $lng; ?>" class="btn">아이디 / 비밀번호찾기</a></li>
						<li class="last">아직 회원이 아니신가요?<a href="<?php echo G5_BBS_URL ?>/register_form.php?lat=<?php echo $lat; ?>&lng=<?php echo $lng; ?>" class="btn">회원가입</a></li>
					</ul>
				</div>
			</div>
		</div>
