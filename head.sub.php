...
if (G5_IS_MOBILE) {
    ...
    echo '<meta name="viewport" content="width=device-width,height=device-height,initial-scale=1.0,minimum-scale=0,maximum-scale=1.0,user-scalable=yes" >'.PHP_EOL;
...
<meta property="og:title" content="기뷰">
<meta property="og:type" content="website">
<meta property="og:image" content="<?php echo G5_IMG_URL."/logo.png"; ?>">
<meta property="og:description" content="기뷰하면 좋은일이 생길거야">
<meta name="description" content="기뷰하면 좋은일이 생길거야">
...
<link rel="stylesheet" href="<?php echo G5_CSS_URL."/jquery.sliderTabs.min.css"; ?>" >
    <!-- 웹폰트 -->
<link href='http://fonts.googleapis.com/earlyaccess/nanumgothic.css' rel='stylesheet' type='text/css'>
<!--[if lt IE 9]>
	<script src="http://html5shiv.googlecode.com/svn/trunk/html5.js"></script>
	<script type="text/javascript" src="<?php echo G5_JS_URL; ?>/respond.js"></script>
<![endif]-->
<!--[if lte IE 8]>
...
<script src="<?php echo G5_JS_URL ?>/jquery.event.drag-1.5.1.min.js"></script>
<script src="<?php echo G5_JS_URL ?>/jquery.touchSlider.js"></script>
<?php
if(G5_IS_MOBILE) {
