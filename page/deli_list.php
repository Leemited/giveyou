...
if($is_member){
	if($lat && $lng){
		...
		$sql = "select a.*, b.* from g5_write_main as a left join store_detail as b on a.wr_id = b.wr_id where a.mb_id !='admin' and a.wr_is_comment=0 and a.wr_file != 0 and a.wr_6 = 'Y' and mb_id != 'admin' {$where} order by a.wr_7 desc, a.wr_1 asc, a.wr_5 desc";
		$query=sql_query($sql);
	}
}else{
