        ...
        <div class="stats_con">
            <div class="select_date">
                <div class="date_search">
                    ...
                    <input type="text"  class="input01" value="<?php echo $year?>" id="datepickers" >
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="position: relative;">
                                    <div id="monthbar" class="month<?php echo $i ?>" onclick="fnDay('<?php echo $wr_id?>','<?php echo ($i+1)?>','<?php echo $year?>')">&nbsp;</div>
                                    <div style="width:100%;background:#ddd; transition: all .2s ease-in-out;text-align: center;padding:5px 0;cursor: pointer;" onclick="fnDay('<?php echo $wr_id?>','<?php echo ($i+1)?>','<?php echo $year?>')"><?php echo $month[$i] ?>건</div>
                                </div>
                            </td>
                        </tr>
                    <?php } ?>
