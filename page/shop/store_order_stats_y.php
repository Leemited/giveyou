...
<div class="width-fixed mt_b_30">
    ...
    <section class="section01">
        <div class="stats_con">
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="position: relative;">
                                    <div id="monthbar" class="month<?php echo $i ?>" onclick="fnYear('<?php echo $wr_id?>','<?php echo $year?>')">&nbsp;</div>
                                    <div style="width:100%;background:#ddd; transition: all .2s ease-in-out;text-align: center;padding:5px 0;" onclick="fnYear('<?php echo $wr_id?>','<?php echo $year?>')"><?php echo $list[$i]["cnt"]?> 건</div>
                                </div>
                            </td>
                        </tr>
                    <?php } ?>
            ...
            <div class="total">
                총 주 문 : <span><?php echo $total?> 건</span>
