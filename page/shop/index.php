            ...
            <ul>
                ...
                <li class="order_list_item" >
                    ...
                    <div class="btn_groups">
						...
						<div class="detail">
							<input type="button" class="btn order_detail_btn" value="주문접수" onclick="fnOrder();">
						</div>
...
function orderdetail(wr_id,order_id){
    location.href=g5_url+"/page/shop/store_order_detail.php?wr_id="+wr_id+"&order_id="+order_id;
...
function fnorderlist(type){
	...
	$.ajax({
		url:g5_url+"/page/ajax/ajax.order_list.php",
		method:"POST",
		data:{wr_id:wr_id,align_type:type}
	}).done(function (data) {
		//alert(data);
		$(".order_list ul").html(data);
	})
...
function fnOrder(wr_id,order_id){
    $.post(g5_url+"/page/shop/store_order_status.php",{wr_id:wr_id,order_id:order_id},function(data){
        $(".modal").html(data);
        modal_active();
    });
}
