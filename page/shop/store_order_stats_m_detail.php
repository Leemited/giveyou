        ...
        <div class="search">
            <form action="<?php echo G5_URL?>/page/shop/store_order_stats_m_detail.php" method="post" name="search">
                <div class="search_input">
                    ...
                    <input type="hidden"  class="input01" value="<?php echo $year?>" name="year" >
                    <input type="hidden"  class="input01" value="<?php echo $month?>" name="month" >
        ...
        <div class="stats_con">
            <div class="select_date">
                <div class="date_search" style="position: relative;">
                    ...
                    <input type="text"  class="input01" value="<?php echo (strlen($month)==1)?"0"+$month:$month;?> 월" id="datepickers" >
            ...
            <div class="date_btn_group" style="padding:10px;">
                <input type="button" class="btn bg_darkred grid_100" value="뒤로 가기" onclick="location.href=g5_url+'/page/shop/store_order_stats_m.php?wr_id=<?php echo $wr_id?>&year=<?php echo $year?>';">
            </div>
            <div class="total">
                총 주 문 : <span><?php echo count($list)?> 건</span>
...
<script>
    $(document).ready(function(){
        ...
        $("input[type=radio]").change(function(){
            align_type = $(this).val();
            if(align_type==0) {
                location.href=g5_url + "/page/shop/store_order_stats.php?wr_id="+<?php echo $wr_id?>;
            }else if(align_type==1){
                location.href=g5_url + "/page/shop/store_order_stats_m.php?wr_id="+<?php echo $wr_id?>;
            }else if(align_type==2){
                location.href=g5_url + "/page/shop/store_order_stats_y.php?wr_id="+<?php echo $wr_id?>;
            }
        })
    ...
    function fnYear(wr_id,month,year){
        location.href=g5_url + "/page/shop/store_order_stats_m_detail.php?wr_id="+wr_id+"&month="+month+"&year="+year;
    }
