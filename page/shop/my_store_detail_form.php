...
/*                    for($i=0;$i<count($file)-1;$i++){
    ...
    <form action="<?php echo G5_URL?>/page/shop/my_store_detail_update.php" method="post" name="store_detail_form" enctype="multipart/form-data" >
