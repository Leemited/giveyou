                                ...
                                <div class="menu_area">
                                    <?php if ($mainsql["wr_7"] == 1) { ?>
                                        ...
                                        <div style="text-align: center">
                                            ...
                                            <?php }?>
                                            <input type="file" name="menu_image" id="menu_image<?php echo $i?>" value="" class="input01 input_file" accept="image/*" onchange="$(this).next().val(this.value)">
                                            <input type="text" readonly style="width:75%;" class="input01 file_text" value="<?php echo  $view[$i]['menu_image']; ?>">
                                            <label for="menu_image<?php echo $i?>" id="main_file_label" class="input01" style="width:25%;">+</label>
                                        </div>
                                    <?php } ?>
                                    ...
                                    <input type="button" value="X" class="btn menu_close_btn" onclick="location.href='<?php echo G5_URL;?>/admin/store_menu_update.php?type=menudel&menu_id=<?php echo $view[$i]["id"];?>&wr_id=<?php echo $wr_id?>&cate_name=<?php echo $ca_name?>'">
                                </div>
                            </form>
                        </dd>
