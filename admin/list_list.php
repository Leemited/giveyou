            ...
            <div class="adm-table01">
                <table>
                    ...
                    if(count($list)==0){
                        ?>
                        <tr>
                            <td colspan="5" class="text-center" style="padding:50px 0;">리스트가 없습니다.</td>
                        </tr>
                        <?php
                    }
                    ?>
                ...
                <div class="num_list01">
                    <ul>
                        ...
                        <?php for($i=$start_page;$i<=$end_page;$i++){ ?>
                            <li class="<?php echo $page==$i?"active":""; ?>"><a href="<?php echo G5_URL."/admin/list_list.php?page=".$i; ?>"><?php echo $i; ?></a></li>
                        <?php } ?>
